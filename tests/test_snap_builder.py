...
# Local
from canonicalwebteam.launchpad_builds import SnapBuilder
...
class SnapBuilderTest(VCRTestCase):
    ...
    def test_02_create_snap(self):
        ...
        self.client.create_snap(snap_name, git_repo)
    ...
    def test_03_build_snap(self):
        result = self.client.build_snap("toto")
